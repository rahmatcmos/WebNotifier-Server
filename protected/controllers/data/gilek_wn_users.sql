...
CREATE TABLE `users` (
  ...
  `resetToken` char(13) COLLATE utf8_polish_ci DEFAULT NULL,
  PRIMARY KEY (`id`),
...
INSERT INTO `users` VALUES (7,'test@test.pl','40bd001563085fc35165329ea1ff5c5ecbdbbeef',NULL);
...
-- Dump completed on 2014-01-27 18:03:16
